...
export class PagSeguroProvider {
  ...
  constructor(private http: HttpClient, private storage: Storage, private datepipe: DatePipe, 
...
export class Dados {
  public id: number;
  public nome: string = 'Eneylton de Jesus Campoas Barros';
  public telefone: string = '(98) 9158-1962';
  public email: string = 'c54553886690761532493@sandbox.pagseguro.com.br';
  public cpf: string = '643.267.643-68';
  public nascimento: string = '16/09/1980';
  public logradouro: string = 'Q.05 Proximo praça verão';
  public numero: string = '36';
  public bairro: string = 'Cohatrac IV';
  public cep: string = '65054-530';
